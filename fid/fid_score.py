...
def get_activations(files, model, batch_size=50, dims=2048, cuda=False, verbose=False, eval_size:int=299):
    ...
    for i in tqdm(range(n_batches)):
        ...
        images = np.array([load_image_resized(fn, eval_size) for fn in files[start:end]])
